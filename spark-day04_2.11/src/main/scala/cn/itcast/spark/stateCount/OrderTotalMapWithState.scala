...
/**
  ...
  */
object OrderTotalMapWithState {
  // 检查点目录
  //  val CHECKPOINT_PATH: String = "datas/streaming/state-order-01111122222"
  val CHECKPOINT_PATH: String = "/business/stream/state-order-0002"
